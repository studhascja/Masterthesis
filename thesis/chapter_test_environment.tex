...
One link which transfers real-time data and another one for transfering non-real-time bulk data.
The  
...
In summary, the goal of the test environment is to transmit both real-time data and standard (non-real-time) data over the same wireless network interface. 
