...
# how to get client_udp could be as easy as but default to a git checkout:
# SRC_URI += "crate://crates.io/client_udp/0.1.0"
SRC_URI += "git://github.com/studhascja/Masterthesis.git;protocol=https;nobranch=1;branch=main"
SRCREV = "${AUTOREV}"
S = "${WORKDIR}/git/code/client_udp"
CARGO_SRC_DIR = "."
...
do_install() {
    install -d ${D}/code
    cp -r ${S} ${D}/code/
    rm -rf ${D}/code/client_udp/.cargo
    rm -rf ${D}/code/client_udp/vendor
    rm -f ${D}/code/client_udp/.gitignore
    rm -f ${D}/code/client_udp/client_udp_0.1.0.bb
}

FILES:${PN} += "/code/client_udp/Cargo.lock \
                /code/client_udp/Cargo.toml \
                /code/client_udp/build.rs \
                /code/client_udp/src/main.rs \
                /code/client_udp/src/bpf/* \
"


# FIXME: update generateme with the real MD5 of the license file
LIC_FILES_CHKSUM = "file://${THISDIR}/files/client_udp/LICENSE;md5=477dfa54ede28e2f361e7db05941d7a7"

SUMMARY = "UDP Client for Test-Environment"
...
include client_udp-${PV}.inc
include client_udp.inc
