...
# how to get server_udp could be as easy as but default to a git checkout:
# SRC_URI += "crate://crates.io/server_udp/0.1.0"
SRC_URI += "git://github.com/studhascja/Masterthesis.git;protocol=https;nobranch=1;branch=main"
SRCREV = "${AUTOREV}"
S = "${WORKDIR}/git/code/server_udp"
CARGO_SRC_DIR = "."
CARGO_BUILD_DIR = "${S}"
...
do_install() {
    install -d ${D}/code
    cp -r ${S} ${D}/code/
    rm -rf ${D}/code/server_udp/.cargo
    rm -rf ${D}/code/server_udp/vendor
    rm -f ${D}/code/server_udp/.gitignore
    rm -f ${D}/code/server_udp/server_*.bb
}

FILES:${PN} += "/code/server_udp/Cargo.lock \
                /code/server_udp/Cargo.toml \
                /code/server_udp/build.rs \
                /code/server_udp/src/main.rs \
                /code/server_udp/src/bpf/* \
"


# FIXME: update generateme with the real MD5 of the license file
LIC_FILES_CHKSUM = "file://${THISDIR}/files/server_udp/LICENSE;md5=477dfa54ede28e2f361e7db05941d7a7"

SUMMARY = "UDP Server for Test-Environment"
...
include server_udp-${PV}.inc
include server_udp.inc
